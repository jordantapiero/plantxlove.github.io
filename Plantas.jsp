...
<html>
    ...
    <link rel="stylesheet" href="./css_Pry/plantas.css">
    ...
    <body>
        ...
        <div class="row">
            <div class="col"> 
				...
				<nav class="navbar navbar-expand-xl navbar-light ">
                    ...
                    <div class="collapse navbar-collapse justify-content-end " id="Menu" style="height: 100%;">
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-12">
				<div class="card " style="width:100%;">
					<img class="card-img-top  img-fluid" src="./img/planta1.jpg" alt="Card image" >
					<div class="card-body">
        ...
        <div class="row">
			...
			<div class="col-lg-3 col-sm-12">
				<div class="card" style="width: 100%;">
					<img class="card-img-top imagen img-fluid" src="./img/7.jpg" alt="Card image" >
					<div class="card-body">
